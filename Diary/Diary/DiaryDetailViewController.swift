...
class DiaryDetailViewController: UIViewController {
    ...
    @objc func tapStarButton() {
        ...
        self.diary?.isStart = !isStar
        NotificationCenter.default.post(name: NSNotification.Name("starDiary"), object: ["diary": self.diary, "isStar" : self.diary?.isStart ?? false, "uuidString": diary?.uuidString], userInfo: nil)
    }
